...
$app_strings = array (
  ...
  'LBL_JS_CALENDAR' => 'Календарь' /*for 508 compliance fix*/,
    ...
    'NTC_OVERWRITE_ADDRESS_PHONE_CONFIRM' => 'Поля с адресными и телефонными данными текущего юр.лица уже содержат значения. Для перезаписи  существующих данных данными выбранного юр.лица нажмите кнопку "OK". Для сохранения текущих значений нажмите кнопку "Отмена".',
   ...
   'LBL_EMAIL_ADDRESS_BOOK_ADD'			    => 'Готово',
    ...
    'LBL_SHIP_TO_ACCOUNT'=>'Отправлено юр.лицу' ,
