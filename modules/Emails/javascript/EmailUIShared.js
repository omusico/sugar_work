...
SUGAR.email2 = {
    ...
    autoSetLayout : function() {
        ...
        /*подстройка под новый дизайн - SUGAR.email2.complexLayout.set('width',YAHOO.util.Dom.getViewportWidth()-40)*/
        SUGAR.email2.complexLayout.set('width',YAHOO.util.Dom.getViewportWidth()-110);
