...
$dictionary['RealtyTemplates'] = array(
	'table'=>'realtytemplates',
	'audited'=>true,
	...
	'longitude' => array(
		...
		"realtytemplates_calls" =>
			array (
				'name' => 'realtytemplates_calls',
				'type' => 'link',
				'relationship' => 'realtytemplates_calls',
				'module'=>'Calls',
				'bean_name'=>'Calls',
				'source'=>'non-db',
				'vname'=>'LBL_REALTYTEMPLATES_CALLS',
			),

		"realtytemplates_meetings" =>
		array (
			'name' => 'realtytemplates_meetings',
			'type' => 'link',
			'relationship' => 'realtytemplates_meetings',
			'module'=>'Meetings',
			'bean_name'=>'Meetings',
			'source'=>'non-db',
			'vname'=>'LBL_REALTYTEMPLATES_MEETINGS',
		),

		"realtytemplates_tasks" =>
		array (
			'name' => 'realtytemplates_tasks',
			'type' => 'link',
			'relationship' => 'realtytemplates_tasks',
			'module'=>'Tasks',
			'bean_name'=>'Tasks',
			'source'=>'non-db',
			'vname'=>'LBL_REALTYTEMPLATES_TASKS',
		),
	...
	'relationships'=>array (
        ...
        'realtytemplates_calls' =>
            array (
                'lhs_module'=> 'RealtyTemplates',
                'lhs_table'=> 'realtytemplates',
                'lhs_key' => 'id',
                'rhs_module'=> 'Calls',
                'rhs_table'=> 'calls',
                'rhs_key' => 'realtytemplates_id',
...
VardefManager::createVardef('RealtyTemplates','RealtyTemplates', array('basic','assignable'));
