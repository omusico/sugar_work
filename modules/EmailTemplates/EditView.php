...
# tracy: review this
if ($focus->sms_only)
	$params[0] = "<span class='pointer'>&raquo;</span>SMS Template";
...
if(true) {
	...
	if($has_campaign || $inboundEmail) {
        ...
        isset($app_list_strings['moduleListSingular']['Contacts']) ? $app_list_strings['moduleList']['Contacts'] : $app_list_strings['moduleList']['Contacts'],
        //isset($app_list_strings['moduleListSingular']['Leads']) ? $app_list_strings['moduleListSingular']['Leads'] : 'Lead',
        isset($app_list_strings['moduleListSingular']['Prospects']) ? $app_list_strings['moduleList']['Prospects'] : 'Target',
    ));
