...
array (
	//kolerts adds
		'source_contact' => array(
			'name' => 'source_contact',
			'vname' => 'LBL_SOURCE_CONTACT',
			'type' => 'enum',
			'options' => 'source_contact_list',
			'len' => 20,
		),
		...
		'dov_lico' => array ( //���������� ����
			...
			'dov_realship' =>	array (//��� ����������
				'name' => 'dov_realship',
				'vname' => 'LBL_DOV_REALSHIP',
				'type' => 'enum',
				'options' => 'contact_realship_list',
				'len' => '255',
			),
			'dov_phone' => array (
				'name' => 'dov_phone',
			...
			'dov_description' => array ( //�����������
				'name' => 'dov_description',
