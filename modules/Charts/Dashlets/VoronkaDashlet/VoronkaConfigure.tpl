...
<tr>
    ...
    <td valign='top' class='dataField'>
    	<input type="text" value="{$dashlet_title}" size="30" name="dashletTitle"/>
    </td>
</tr>
<tr>
    <td valign='top' nowrap class='dataLabel'>{$LBL_DATE_START} <br><i>{$user_date_format}</i></td>
    <td valign='top' class='dataField'>
    	<input onblur="parseDate(this, '{$cal_dateformat}');" class="text" name="v_date_start" size='12' maxlength='10' id='date_start' value='{$date_start}'>
...
<tr>
    ...
    <td valign='top' class='dataField'>
    	<input onblur="parseDate(this, '{$cal_dateformat}');" class="text" name="v_date_end" size='12' maxlength='10' id='date_end' value='{$date_end}'>
...
<!--<tr>
	...
	<td valign='top' class='dataField'>
		<select name="v_ids[]" multiple size='3'>
			{$v_ids}
		</select>
	</td>
</tr>-->
