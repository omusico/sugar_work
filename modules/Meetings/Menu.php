...
if(ACLController::checkAccess('Meetings', 'list', true))$module_menu[]=Array("index.php?module=Meetings&action=pokaz_calendar&return_module=Meetings&return_action=index", $mod_strings['LNK_POKAZ_CALENDAR'],'Meetings');
