...
$dictionary['Meeting'] = array('table' => 'meetings',
  ...
  'result' =>array (
    'name' => 'result',	//результат показа
    'vname' => 'LBL_RESULT',
    'type' => 'text',
  ),
  'why_not_held' => array ( //причина
    'name' => 'why_not_held',
    'vname' => 'LBL_WHY_NOT_HELD',
    'type' => 'varchar',
  ),
  'disable_next' => array ( //не назначать следующий показ
    'name' => 'disable_next',
    'vname' => 'LBL_DISABLE_NEXT',
    'type' => 'bool',
  ),
  'name' =>
  array (
...
'sms_reminder_checked' => array(
            'name' => 'sms_reminder_checked',
            'vname' => 'LBL_SMS_REMINDER',
            'type' => 'bool',
            'source' => 'non-db',
            'comment' => 'checkbox indicating whether or not the sms reminder value is set (Meta-data only)',
            'massupdate' => false,
        ),
        'sms_reminder_time' =>
        array (
            'name' => 'sms_reminder_time',
            'vname' => 'LBL_SMS_REMINDER_TIME',
            'type' => 'enum',
            'dbType' => 'int',
            'options' => 'reminder_time_options',
            'reportable' => false,
            'massupdate' => false,
            'default'=> -1,
            'comment' => 'Specifies when a sms reminder alert should be issued; -1 means no alert; otherwise the number of seconds prior to the start'
        ),
        'sms_reminder_sent' => array(
            'name' => 'sms_reminder_sent',
            'vname' => 'LBL_SMS_REMINDER_SENT',
            'default' => 0,
            'type' => 'bool',
            'comment' => 'Whether sms reminder is already sent',
            'studio' => false,
            'massupdate'=> false,
        ),
   'outlook_id' =>
