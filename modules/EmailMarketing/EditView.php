...
# tracy: moved from below
$campaign_id = $focus->campaign_id ? $focus->campaign_id : $_REQUEST['campaign_id'];
//include campaign utils..
require_once('modules/Campaigns/utils.php');
$campaign = new Campaign();
$campaign->retrieve($campaign_id);
$campaign_name = empty($_REQUEST['campaign_name']) ? $campaign->name : $_REQUEST['campaign_name'];
$campaign_type = empty($_REQUEST['campaign_type']) ? $campaign->campaign_type : $_REQUEST['campaign_type'];


$GLOBALS['log']->info("EmailMarketing Edit View");
#tracy: this is for SMS-specific labels
if ($campaign->campaign_type == "SMS") { 
	 $mod_strings['LBL_MODULE_NAME'] = "SMS Маркетинг";
	 $mod_strings['LBL_TEMPLATE'] = "SMS Шаблон";
} 
