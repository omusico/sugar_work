...
if (!empty($alltabs)) {
    ...
    # tracy: defines the subpanels that are not needed for SMS campaigns
    $sp_not_for_sms = array("contact","lead","leads","accounts","removed","viewed","link","blocked","campaign_sugartalk_sms");
