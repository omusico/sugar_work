...
<script src="custom/modules/Request/tpls/script.js"></script>
...
*}
   {* <tr>
        <td valign="top" id="address_label" width="25%" scope="row" >
            <label for="address">{sugar_translate label="LBL_ADDRESS" module=""}:</label>
        </td>
        <td>
            <input type="text" name="address" id="address" size="60" maxlength="250" value="" tabindex="0">
