...
class RealtyTemplatesViewPopup extends SugarView{
	var $type ='list';
	function ViewPopup(){
		parent::SugarView();
	}
	...
	function display(){
		...
		if(!empty($listViewDefs) && !empty($searchdefs)){
			...
			if(isset($_REQUEST['check_popup']))//kolerts
				$popup->setup('custom/modules/RealtyTemplates/tpls/realtytemplates_opportunitiesPopupGeneric.tpl');
			else
