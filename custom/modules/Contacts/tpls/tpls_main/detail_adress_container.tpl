    ...
    <table border='0' cellpadding='0' cellspacing='0' width='100%'>
        <tr>
            <td width='99%'>
                ...
                <input type="hidden" class="sugar_field" id="address_appartment" value="{$fields.address_appartment.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}">
                ...
                {$fields.address_appartment.value|escape:'htmlentitydecode'|strip_tags|url2html|nl2br}
